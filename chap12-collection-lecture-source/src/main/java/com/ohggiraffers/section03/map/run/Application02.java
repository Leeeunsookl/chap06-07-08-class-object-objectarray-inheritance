package com.ohggiraffers.section03.map.run;
...
public class Application02 {
    ...
    public static void main(String[] args) {
        ...
        /* 필기.
        *   Properties란?
        *   HashMap을 구현하여 사용용법이 거의 유사하지만, key와 value 모두 문자열만
        *   사용할 수 있는 자료구조이다.
        *   설정 파일의 값을 읽어서 어플리케이션이 적용할 때 사용한다.
        *  */
        ...
        }       //try 해당구문 실행될 때 예외가 발생하면 catch구문으로 잡아서 오류발생시킬거야
        catch (IOException e) {

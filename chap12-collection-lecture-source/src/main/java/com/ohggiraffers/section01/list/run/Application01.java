package com.ohggiraffers.section01.list.run;
...
public class Application01 {
    ...
    public static void main(String[] args) {
       ...
       *   크기변경 (새로운 더 큰 배열 만들고 옮기기), 요소의 추가 수정 삭제 정렬 기능을
       ...
       *  */
        ...
        *   */
        ...
        /* 필기. arraylist의 크기는 size() 로 확인할 수 있다.
        ...
        * */
        ...
        alist.set(1,true);      //값을 수정할 때, 오토박싱이 되고 있는 것.
        System.out.println("alist = " + alist);
...
//        stringList.add(123);      //지정한 타입 이외의 인스턴스는 저장하지 못한다.
        ...
        Collections. sort(stringList);      //정리해준다
        System.out.println("stringList = " + stringList);
        ...
        *  */
        ...
        Iterator<String>dIter= ((LinkedList)stringList).descendingIterator();       //내림차순으로 배열

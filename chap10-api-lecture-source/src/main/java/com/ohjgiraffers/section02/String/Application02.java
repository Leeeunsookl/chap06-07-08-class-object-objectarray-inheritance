package com.ohjgiraffers.section02.String;
...
public class Application02 {
    ...
    public static void main(String[] args) {
        ...
        *  */
        ...
        /* 필기.
        *   하지만 4개의 문자열 모두 동일한 hashcode를 가진다.
        *   동일한 문자열은 동일한 hashcode를 갖게 재정의 되어 있다.
        *  */
        ...
        *              따라서 문자열 인스턴스 생성 방식과 상관 없이 동일한 문자열인지 비교하기 위해

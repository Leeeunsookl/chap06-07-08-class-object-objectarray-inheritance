package com.ohjgiraffers.section03.stringbuilder;

public class Application01 {

    public static void main(String[] args) {
        /* 수업목표. String과 StringBuilder의  차이점에 대해 이해할 수 있다. */
        /* 필기.
        ...
        *                   따라서 잦은 문자열 변경시 String보다 성능이 좋다.
        *  */

        StringBuilder sb= new StringBuilder("java");
        System.out.println("sb = " + sb);       //toString이 기본으로 쓰여져 있어서 바로 java로 나온다!

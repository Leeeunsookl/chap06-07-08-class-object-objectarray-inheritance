...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        /* 필기.
        *   super : 자식클래스를 이용해서 객체를 생성할 때 부모생성자를 호출해서
        ...
        *  */
        ...
        Product product2= new Product("A-1234","삼송","갤럭시2",20000, new java.util.Date());

...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        *       상속의 구조가 복잡해질수록 그 영향에 대한 예측이 힘들며 이런 단점이 유지보수성이

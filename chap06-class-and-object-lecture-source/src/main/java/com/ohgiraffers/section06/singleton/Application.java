...
//        EagerSingleton eager =new EagerSingleton();      생성자가 private 이기 때문에 접근 불가
        ...
        System.out.println("eager1 의 주소 : " + eager1.hashCode());
        System.out.println("eager2 의 주소 : " + eager2.hashCode());

        /*목차 2. 게으른 초기화 구현*/
        LazySingleton lazy1 = LazySingleton.getInstance();
        LazySingleton lazy2 = LazySingleton.getInstance();

        System.out.println("lazy1 의 주소 : " + lazy1.hashCode());
        System.out.println("lazy2 의 주소 : " + lazy2.hashCode());

        /*필기.
         *  이른 초기화를 사용하면 처음 인스턴스 반환 요청에서 속도가 빠르다
         *  하지만 클래스를 로드하는 속도가 느리다
         *  게으른 초기화를 사용하면 첫번째 요청에 대한 속도가 두번째 요청에 대한 속도보다 느리다

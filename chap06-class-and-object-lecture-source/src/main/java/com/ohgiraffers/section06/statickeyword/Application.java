...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        /* 필기.
        *   static
        *   :정적 메모리 영역에 프로그램이 start 될 때 할당을 하는 키워드이다. (어떤 코드를 만나도 메모리에 안올라간다)
        *    인스턴스를 생성하지 않고도 사용할 클래스의 멤버(필드,메소드)에 지정할 수 있다.
        *    여러 인스턴스가 공유해서 사용할 목적의 공간이다. //에어컨!!!!!!!!!!!!!!!!!!!!!!!
        *    하지만 static 키워드의 남발은 유지보수와 추적이 힘든 코드를 작성한느 피해야 할 방식이다.
        ...
        *  */
        ...
        System.out.println("non-static field : " + sft2.getNonStaticCount());       //static이 아니니 기본값으로 돌아가는거고
        System.out.println("static field : " + sft2.getStaticCount());         //static은 바뀐거 프로그램 종료까지 계속 유지

        /* 필기.
        *   인스턴스 변수(static이 붙지 않은)의 경우 sft1과 sft2 두 개의 인스턴스가 서로 값을 공유하지 못하고

...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        *   */
        ...
        int age = 20;
        char gender = '남';
        String[] hobby = {"야구", "배드민턴", "탁구"};      // new String[] {"야구", "배드민턴", "탁구"};

        System.out.println("id = " + id);
        System.out.println("pwd = " + pwd);
        System.out.println("name  = " + name );
        System.out.println("hobby = " + age);
        System.out.println("hobby = " + gender);
        ...
        *   1. 변수명을 다 관리해야하는 어려움이 생긴다. (변수명을 다 알고 있어야 한다.)
        *   2. 모든 회원 정보를 인자로 메소드 호출 시 값을 전달해야 하면
        *      너무 많은 값들을 인자로 전달해야해서 한 눈에 안 들어온다.
        ...
        *  */
        ...
        /* 필기.
        *   이렇게 위에서처럼 객체를 생성하고 나면, 서로 다른 자료형들은 하나의 member라는 변수명으로 관리할 수 있도록 공간을 생성한 것이다.
        *   heap이라는 공간에 생성되기 때문에 jvm이 제공하는 기본값들로 초기화 된다.
        *   */

        /* 필기.
        *   필드에 접근하기 위해서는 주소값을 저장하고 있는 변수인 래퍼런스변수명, 필드명 <-이렇게 접근한다.

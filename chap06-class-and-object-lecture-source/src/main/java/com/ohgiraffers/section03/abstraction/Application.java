...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        *   본인의 상태를 스스로 제어하어 행동하도록 한다는 것이 현실 세계와 다른 것이다. (캡슐화)
        ...
        *   */
        ...
        /* 필기.
        *   객체를 설계하기 위해서는 복잡한 현실 세계를 반영하기엔 너무 방대하고 복잡하므로
        *   현실 세계를 프로그램의 목적에 맞게 단순화하는 '추상화'라는 기법을 적용.
        *   */
        ...
        *   메세지(메소드 호출)를 보내는 쪽을 송신자, 메세지(메소드)를 수신하는 쪽을 수신자라고 한다.
        *   수신자는 메세지를 전달받아 그 메세지에 해당하는 내용을 처리하는 방법을 스스로 결정하고,
        *   그 결정한 방법대로 처리할 명령어들을 순차적으로 기술한 것을 메소드라고 한다.
        *   상호작용에 중요한 것은 메세지를 송수신하고 그 방법을 기술하여 메세지에 응답하는
        *   상호작용을 설계하는 것이다.
        ...
        *   */      //카레이서가 명령 "속도를 올려라" -> 자동차가 듣고 본인이 직접 하는 것

        /* 필기.
        *   시스템 요구사항
        *   1. 카레이서는 시동 걸기, 엑셀레이터 밟기, 브레이크 밟기, 시동 끄기를 할 수 있다.
        *   2. 자동차는 시동 걸기, 앞으로 가기, 멈추기, 시동끄기를 할 수 있다.
        ...
        *    2. 가속하기
        *    - 사용자 --> 엘섹레이터를 밟아라 --> 카레이서 --> 앞으로 가라 --> 자동차
        *    3. 정지하기
        ...
        *   목차. 4.클래스 설계하기(정적)
        *    1. 카레이서 클래스
        *    - 속성 : 자동차         //new로 자동차를 만들어야 메소드를 가지고 올 수 있으니
        ...
        *   */
        ...
        while(true){
            ...
            switch (num){
                ...
                case 4 : racer.finish(); break;
                case 9 :
                    System.out.println("프로그램을 종료합니다.."); break;
                default:        //그냥 else라고 생각하면 됨
